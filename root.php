...
<!--公众号模块 -->
<div style="z-index: 9999; position: fixed ! important; left: 0; top: 120px;">
    <?php
    $UserID=$_GET["UserID"];
    echo "<a href='rootgzh.php'>";
    echo '<button type="submit" class="tm-btn-subscribe">公众号管理</button>';
    echo '</a>'
    ?>
</div>
<!--搜索用户模块 -->
<div style="z-index: 9999; position: fixed ! important; left: 0; top: 220px;">
    <form method="post" class="subscribe-form" action="searchresult.php">
        <input name="cusid" type="text" class="form-control" id="username" placeholder="请输入要查找的用户" />
        <button type="submit" class="tm-btn-subscribe">查询用户</button>
    </form>
</div>
<!--注销模块-->
